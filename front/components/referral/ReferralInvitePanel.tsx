...
function Tile({
  ...
  const valueCls = tone === 'money' ? 'text-emerald-400' : 'text-white';
  return (
      ...
      <div>
        ...
        {status.friends.length > 0 ? (
          ...
          <div className="mt-2 flex flex-col items-center gap-1 rounded-panel border border-dashed border-white/10 p-6 text-center">
            ...
            <span className="text-sm font-semibold text-white">Вы ещё не пригласили друзей</span>
            <span className="text-xs text-muted-foreground">Начните приглашать и зарабатывать!</span>
          </div>
        )}
      </div>
    </>
