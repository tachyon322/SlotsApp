...
const AttachmentPreviewDialog: FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <Dialog>
      ...
      />
      <DialogContent className="aui-attachment-preview-dialog-content [&>button]:bg-foreground/60 [&>button]:hover:bg-foreground/80 [&_svg]:text-background p-2 sm:max-w-[48rem] [&>button]:rounded-full [&>button]:p-1 [&>button]:opacity-100 [&>button]:ring-0!">
