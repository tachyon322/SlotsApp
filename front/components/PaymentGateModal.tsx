...
const GATE_COPY: Record<GatePurpose, {
  ...
  premium: {
    ...
    subtitle: 'Обязательная Премиум подписка (2 000 ₽) — без неё вывод средств недоступен. Открывает следующий шаг — приглашение друзей',
    itemLabel: 'Премиум подписка (бессрочно)',
    successTitle: 'Премиум активирован!',
    successText: 'Подписка успешно активирована! Следующий шаг — пригласить 3 друзей',
  },
};
